export const API_ENDPOINTS = {
  ...
  DASHBOARD_PRESALES: '/api/dashboard/presales',
  DASHBOARD_SALES: '/api/dashboard/sales',
  DASHBOARD_MARKETING: '/api/dashboard/marketing',
  DASHBOARD_ADMIN_USERS: (type: string) => `/api/dashboard/admin/users/${type}`,
  DASHBOARD_ADMIN_SOURCES: '/api/dashboard/admin/sources',
